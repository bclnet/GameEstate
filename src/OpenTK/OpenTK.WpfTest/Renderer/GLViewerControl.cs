...
namespace OpenTK.WpfTest.Renderer
{
    public class GLViewerControl : GLControl
    {
        ...
        readonly DispatcherTimer _timer = new() { Interval = new TimeSpan(10) };

        public GLViewerControl() { if (!IsInDesignMode) ConsoleManager.Show(); }
        ...
        protected override void OnMouseEnter(MouseEventArgs e) { Camera.MouseOver = true; }

        protected override void OnMouseLeave(MouseEventArgs e) { Camera.MouseOver = false; }
        ...
        void Draw()
        {
            ...
            Camera.HandleInput(Input.Mouse.GetState(), Input.Keyboard.GetState());
