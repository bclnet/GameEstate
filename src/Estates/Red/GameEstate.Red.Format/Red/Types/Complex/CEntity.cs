...
using GameEstate.Red.Formats.Red.Types.BufferStructs.Complex;
using System.IO;
    ...
    public partial class CEntity : CNode
    {
        ...
        public override void Read(BinaryReader file, uint size)
        {
            ...
            if (!isCreatedFromTemplate)
            {
                ...
                else throw new EndOfStreamException("unknown CEntity Fileformat.");
            }
            ...
            if (isCreatedFromTemplate)
            {
                if (bytesleft > 0) BufferV2.Read(file, 0);
                else throw new EndOfStreamException("unknown CEntity Fileformat.");
            }
