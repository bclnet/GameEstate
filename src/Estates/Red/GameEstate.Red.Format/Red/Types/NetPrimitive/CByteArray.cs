...
namespace GameEstate.Red.Formats.Red.Types
{
    ...
    public class CByteArray : CVariable, IByteSource
    {
        ...
        public override void Read(BinaryReader r, uint size) => Bytes = r.ReadBytes((int)r.ReadUInt32());
        ...
        public override CVariable SetValue(object val)
        {
            switch (val)
            {
                ...
                case CByteArray cvar: Bytes = cvar.Bytes; break;
            }
            return this;
        }
        ...
        public override string ToString()
        {
            ...
            else return $"{Bytes.Length} bytes";
        }
    }
}