...
[assembly: ContractNamespace("", ClrNamespace = "GameEstate.Red.Formats.Red.CR2W")]

namespace GameEstate.Red.Formats.Red.CR2W
{
    [DataContract(Namespace = ""), StructLayout(LayoutKind.Explicit, Size = 24)]
    public struct CR2WExport
    {
        [DataMember, FieldOffset(0)] public ushort className;        //needs to be registered upon new creation and updated on file write!   //done
        [DataMember, FieldOffset(2)] public ushort objectFlags;      // 0 means uncooked, 8192 is cooked //TODO
        ...
        [DataMember, FieldOffset(4)] public uint parentID;
        [DataMember, FieldOffset(8)] public uint dataSize;           // created upon data write  //done
        [DataMember, FieldOffset(12)] public uint dataOffset;         // created upon data write  //done
        [DataMember, FieldOffset(16)] public uint template;           // can be 0 //TODO?
        [DataMember, FieldOffset(20)] public uint crc32;              // created upon write   //done
    }
    ...
    public class CR2WExportWrapper
    {
        ...
        CR2WExport _export;
        [DataMember()] public CR2WExport Export => _export;

        [NonSerialized]
        public CBytes unknownBytes;

        [JsonIgnore] public CR2WFile cr2w { get; }
        [JsonIgnore] public CVariable data { get; private set; }
        ...
        [JsonIgnore] public List<CR2WExportWrapper> ChildrenChunks => cr2w.Chunks.Where(_ => _.ParentChunk == this).ToList();

        [JsonIgnore] public List<CR2WExportWrapper> VirtualChildrenChunks => cr2w.Chunks.Where(_ => _.VirtualParentChunk == this).ToList();
        ...
        [DataMember] public string REDName => $"{REDType} # {ChunkIndex}";
        ...
        /// Do not delete!
        /// </summary>
        public string REDValue => ToString();
        ...
        public void ReadData(BinaryReader file)
        {
            ...
            if (bytesLeft > 0) unknownBytes.Read(file, (uint)bytesLeft);
            else if (bytesLeft < 0) { } //throw new InvalidParsingException("File read too far.");
            else unknownBytes.Bytes = new byte[0];
        }
        ...
        public void CreateDefaultData(CVariable cvar = null)
        {
            ...
            data = cvar == null
                ? CR2WTypeManager.Create(REDType, REDType, cr2w, ParentChunk?.data)
                : cvar;
        ...
        public virtual bool CanRemoveVariable(IEditableVariable child) => false;
        public virtual bool CanAddVariable(IEditableVariable newvar) => false;
        public virtual void AddVariable(CVariable var) { }

        public virtual bool RemoveVariable(IEditableVariable child) => false;
        public void SetREDName(string val) => throw new NotImplementedException();

        public void Read(BinaryReader file, uint size) => throw new NotImplementedException();
        public void Write(BinaryWriter file) => throw new NotImplementedException();
        public CVariable Copy(CR2WCopyAction context) => throw new NotImplementedException();
    }
}
