...
namespace GameEstate.Red.Formats.Red.CR2W
{
    ...
    {
        public Dictionary<CR2WExportWrapper, CR2WExportWrapper> chunkTranslation = new Dictionary<CR2WExportWrapper, CR2WExportWrapper>(); // source, target
        ...
        void DeepChunkCopy(CR2WExportWrapper sourcechunk, CR2WExportWrapper destinationchunk, bool inplace = true)
        {
            Parent = null;
        ...
        internal CR2WExportWrapper TryLookupReference(CR2WExportWrapper oldExportWrapper, CVariable targetVariable = null)
        {
            ...
            // Try last way
            var vardepstring = targetVariable != null
                ? targetVariable.GetFullDependencyStringName()
                : null;
