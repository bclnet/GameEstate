...
namespace GameEstate.Red.Formats.Red.CR2W
{
    ...
    public class HslColor
    {
        ...
        public static HslColor FromRgb(Color clr) => FromRGB(clr.R, clr.G, clr.B);
        ...
        /// </summary>
        /// <returns></returns>
        public int GetSaturation() => (int)(100 * Saturation);

        /// <summary>
        /// Gets the Luminosity in 1-100 range.
        /// </summary>
        /// <returns></returns>
        public int GetLuminosity() => (int)(100 * Luminosity);

        /// <summary>
        /// Sets the HUE value.
        /// </summary>
        /// <param name="value">Percentage of HUE.</param>
        public void SetHue(int value) => Hue = (float)value / 60;

        /// <summary>
        /// Sets the Saturation value.
        /// </summary>
        /// <param name="value">Percentage of Saturation.</param>
        public void SetSaturation(int value) => Saturation = (float)value / 100;

        /// <summary>
        /// Sets the Luminosity value.
        /// </summary>
        /// <param name="value">Percentage of Luminosity.</param>
        public void SetLuminosity(int value) => Luminosity = (float)value / 100;
        ...
        public static HslColor FromRGB(Byte R, Byte G, Byte B)
        {
            ...
            if (_Delta != 0)
            {
                if (L < 0.5f) S = (float)(_Delta / (_Max + _Min));
                else S = (float)(_Delta / (2.0f - _Max - _Min));
