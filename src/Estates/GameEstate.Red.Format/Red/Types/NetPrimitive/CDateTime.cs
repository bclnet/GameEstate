...
namespace GameEstate.Red.Formats.Red.Types
{
    ...
    public sealed class CDateTime : CVariable/*, IEquatable<CDateTime>*/
    {
        ...
        /// </summary>
        /// <param name="value"></param>
        public CDateTime(DateTime value, CVariable parent, string name, CR2WFile cr2w = null) : base(cr2w, parent, name) { _value = value; }
        ...
        public CDateTime(ulong value, CVariable parent, string name, CR2WFile cr2w = null) : base(cr2w, parent, name) { TryParse(this, value); }
        ...
        public static bool TryParse(CDateTime datetime, ulong value)
        {
            // date
            value >>= 0xA;
            ...
            try
            {
                datetime._value = new DateTime(year, month, day, hour, minute, second, millisecond);
            }
        ...
        public override void Read(BinaryReader r, uint size) => TryParse(this, r.ReadUInt64());

        public override void Write(BinaryWriter w) => w.Write(ToUInt64());

        //public static new CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new CDateTime(cr2w, parent, name);
