...
using GameEstate.Valve.Formats.Blocks;
using GameEstate.Valve.Formats.Blocks.Animation;
using GameEstate.Valve.Formats.OpenGL;
using OpenStack;
...
namespace GameEstate.Valve.Graphics.OpenGL.Scenes
{
