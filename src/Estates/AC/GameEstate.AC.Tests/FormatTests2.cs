...
namespace GameEstate.AC
{
    ...
    public class FormatTests2
    {
        ...
        static readonly EstatePakFile portal = estate.OpenPakFile(new Uri("game:/client_portal.dat#AC"));
        static readonly EstatePakFile cell = estate.OpenPakFile(new Uri("game:/client_cell_1.dat#AC"));
        static readonly EstatePakFile localEnglish = estate.OpenPakFile(new Uri("game:/client_local_English.dat#AC"));
        ...
        static void LoadObject<T>(EstatePakFile source, string sampleFile)
        {
