...
namespace GameEstate.AC
{
    ...
    {
        static readonly Estate estate = EstateManager.GetEstate("AC");
        static readonly EstatePakFile cell = estate.OpenPakFile(new Uri("game:/client_cell_1.dat#AC")); const int ExpectedCellCount = 805003;
        static readonly EstatePakFile portal = estate.OpenPakFile(new Uri("game:/client_portal.dat#AC")); const int ExpectedPortalCount = 79694;
        static readonly EstatePakFile localEnglish = estate.OpenPakFile(new Uri("game:/client_local_English.dat#AC")); const int ExpectedLocalEnglishCount = 118;
