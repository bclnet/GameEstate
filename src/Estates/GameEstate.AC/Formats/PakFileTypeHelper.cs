    ...
    public static class PakFileTypeHelper
    {
        ...
        public static (PakFileType type, object ext)? GetFileType(uint objectId, PakType pakType)
        {
            ...
            else if (pakType == PakType.Portal)
            {
                ...
                else if (objectId == 0x0E000003) return (PakFileType.SecondaryAttributeTable, "");
                else if (objectId == 0x0E000004) return (PakFileType.SkillTable, "");
                ...
                else if (objectId == 0x0E00001D) return (PakFileType.ContractTable, "");
