...
namespace GameEstate.Valve
{
    ...
    {
        static readonly Estate estate = EstateManager.GetEstate("Valve");
        static readonly EstatePakFile dota2 = estate.OpenPakFile(new Uri("game:/dota/pak01_dir.vpk#Dota2"));
